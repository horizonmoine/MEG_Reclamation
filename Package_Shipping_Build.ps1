...
# Fermeture preventive des processus editeur pour eviter les verrous UBT/LiveCoding
...
if ($Code -eq 0) {
    ...
    Write-Host "Executable pret a jouer : $ARCHIVE_DIR\MEG_Reclamation.exe" -ForegroundColor Green
} else {
